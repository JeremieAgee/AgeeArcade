...
// `speedMult` > 1 shortens flight time for a faster, flatter shot.
// Returns THREE.Vector3 velocity.
function computeLaunchVelocity(muzzlePos, targetPos, gravity, speedMult) {
  gravity = gravity || 14;
  ...
  const T = Math.max(0.6, Math.min(2.5, hDist / 22)) / speedMult;
